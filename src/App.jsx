...
function InvoiceForm() {
  ...
  return (
    <div className="mt-4 max-w-4xl mx-auto p-3 border-2 border-gray-300 rounded-lg shadow-lg invoice-container">
      <div className="flex flex-col md:flex-row justify-between items-start">
        <div className="flex flex-col md:flex-row">
          ...
          >
            {!formData.image ? (
              <>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-16 text-blue-300 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="mt-5 flex flex-col space-y-3 md:w-1/2">
        {["Your Company", "Your Name", "Company's GSTIN", "Company's Address", "City", "State", "Country"].map((placeholder, index) => (
          <input key={index} type="text" className="outline-none border py-1 border-transparent hover:border-blue-300 transition object-cover leading-loose" placeholder={placeholder} />
        ))}
      </div>
      ...
      <div className="mt-10 flex flex-col md:flex-row justify-between">
        ...
        <div className="flex flex-col">
          <div className="flex flex-row justify-between items-center">
            ...
            <input type="text" className="outline-none border border-transparent hover:border-blue-300 transition flex-1 object-cover leading-loose" placeholder="INV-12" />
          </div>
          <div className="flex flex-row justify-between items-center mt-1">
            <h4 className="font-bold w-32">Invoice Date</h4>
            <input type="date" className="outline-none border border-transparent hover:border-blue-300 transition flex-1 object-cover leading-loose" />
          </div>
          <div className="flex flex-row justify-between items-center mt-1">
      ...
      <div className="flex mt-8">
        ...
        <input type="text" className="outline-none border border-transparent hover:border-blue-300 transition flex-1 object-cover leading-loose" placeholder="State" />
      </div>
              ...
              <tr key={index} className="border-b">
                <td>
                  <input
                    ...
                    className="outline-none w-[200%] mt-2 border border-transparent hover:border-blue-300 transition object-cover leading-loose"
                  />
                  <input
                    type="text"
                    placeholder="HSN/SAC"
                    ...
                    className="outline-none w-full mt-4 mb-4 border border-transparent hover:border-blue-300 transition object-cover leading-loose"
                  />
                </td>
                <td>
                  <input
                    ...
                    className="outline-none w-16 text-right border border-transparent hover:border-blue-300 transition object-cover leading-loose"
                  />
                </td>
                <td>
                  <input
                    ...
                    className="outline-none w-20 text-right border border-transparent hover:border-blue-300 transition object-cover leading-loose"
                  />
                </td>
                <td>
                  <input
      ...
      <div className="mt-4">
        <h4>Notes</h4>
        <input type="text" className="text-black w-full mt-2 outline-none border-2 border-transparent hover:border-blue-300 transition object-cover leading-loose" placeholder="It was great doing business with you." />
      </div>
      <div className="mt-4">
        <h4>Terms & Conditions</h4>
        <input type="text" className="text-black w-full mt-2 outline-none border-2 border-transparent hover:border-blue-300 transition object-cover leading-loose" placeholder="Please make the payment by the due date." />
      </div>
